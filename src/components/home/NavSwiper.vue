	...
	<div class='navSwiper'>
		<div class='content'>
			<div class='navigation'>
				<ul>
					<li v-for='item in getFirst' :key='item.id' @mouseenter="mouseHover(item.id)" @mouseleave="mouseOut">
						<router-link to='/'>
                            {{item.categoryName}}
						...
						<div class='category-detail' v-if='isFirst'>
							<div class='detail-main'>
								...
								<div class='detail-list'>
									...
									<div class='list-ul'>
										<router-link to='/' class='list-item' v-for="index in tagsPageList" :key="index.id">
                                         {{index.tagName}}
                                        </router-link>
									</div>
								</div>
								<div class='detail-class'>
									<div class='course-card' v-for="idx in searchCourseList" :key="idx.id">
										<div class='course-image'>
											<img :src="idx.courseCover">
										</div>
										<div class='right'>
											<div class='courseName'>
												{{idx.courseName}}
											</div>
											<div class="courseDegree">{{ courseTypeFn(idx.courseLevel) }} · {{idx.purchaseCounter + idx.purchaseCnt }}人购买</div>
											<div class='buy'>
												<div class='buy-free'>
													<div class='coursePrice'>
														...
														<div class='price'>¥{{idx.discountPrice}}</div>
													</div>
													<div class='cart'>
			...
			<div class='sliders'>
				<el-carousel :interval="5000" arrow="always"  height="460px" v-if='sliderList.length>0'>
		...
		<div class='course-type'>
			<div class='course-type-item'>
				<router-link to='/'>
					<div class='course-type-item-icon'>
						<img src="@/assets/images/chuji.png">
					</div>
			...
			<div class='course-type-item'>
				<router-link to='/'>
					<div class='course-type-item-icon'>
						<img src="@/assets/images/zhongji.png">
					</div>
					<div class='course-type-item-text'>
			...
			<div class='course-type-item'>
				<router-link to='/'>
					<div class='course-type-item-icon'>
						<img src="@/assets/images/gaoji.png">
					</div>
					<div class='course-type-item-text'>
			...
			<div class='course-type-item'>
				<router-link to='/'>
					<div class='course-type-item-icon'>
						<img src="@/assets/images/suanfa.png">
					</div>
					<div class='course-type-item-text'>
...
import {getFirstCategorys,tagsList,searchCourse,getSliders}from '@/api/index.js'
...
.navSwiper{
    ...
    width: 100%;
    height: 640px;
    background: url('@/assets/images/transitionbg.png') no-repeat;
}
.content{
	position: relative;
	display: flex;
